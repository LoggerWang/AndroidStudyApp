...
//            params = (MarginLayoutParams) child.getLayoutParams();
           ...
           int cwidth=childrenView.getMeasuredWidth();
            int cheight=childrenView.getMeasuredHeight();
            params= new MarginLayoutParams(cwidth,cheight);
